...
const sub = document.getElementById("countdown");
...
// window.onload = function () {
  ...
  setTimeout(() => {
    ...
    sub.innerHTML = "The horse #"+result+" won!";
    setTimeout(() => {
      position1 = 20;
      horse1.style.left = position1 + "px";
      position2 = 20;
      horse2.style.left = position1 + "px";
      position3 = 20;
      horse3.style.left = position1 + "px";
      position4 = 20;
      horse4.style.left = position1 + "px";
      position5 = 20;
